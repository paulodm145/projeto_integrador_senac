...
<body class="bg-gradient-primary">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img src="../img/conexao_rh_logo_empresa.png" class="img-fluid" alt="" style="width: 700px; height: 320px;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" id="UserForm" method="POST" action="../php/decode.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="sessHash" name="sess_hash">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <a onclick="toHash()" class="btn btn-primary btn-user btn-block">
                                            Entrar
                                        </a>
    ...
    <script src="../js/sausage.js"></script>
